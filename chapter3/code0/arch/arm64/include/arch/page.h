...
#define TCR_IRGN0                   BIT_CLEAR(9) | BIT_CLEAR(8)
#define TCR_ORGN0                   BIT_CLEAR(11) | BIT_CLEAR(10)
#define TCR_SH0                     BIT_CLEAR(13) | BIT_CLEAR(12)
#define TCR_TG0                     BIT_CLEAR(15) | BIT_CLEAR(14)
#define TCR_T1SZ                    (((UL(64)) - (VA_BITS)) << (TCR_T1SZ_SHIFT))
#define TCR_A1                      BIT_SET(22)
#define TCR_IRGN1                   BIT_CLEAR(25) | BIT_CLEAR(24)
#define TCR_ORGN1                   BIT_CLEAR(27) | BIT_CLEAR(26)
#define TCR_SH1                     BIT_CLEAR(29) | BIT_CLEAR(28)
